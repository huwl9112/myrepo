...
$(function() {
   ...
   // 刷新图形验证码
	...
	function checkUserName(){
		...
		alert(username);
		$("#span1").load("${pageContext.request.contextPath}/user/CheckUserName?"+new Date().getTime(),{'username':username}); */
		// ajax
		$.ajax({
			type : "GET",
					...
					<form id="registerForm"
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="10" autocomplete="off">&nbsp;&nbsp;&nbsp;<img
								...
								<tr>
									<th>&nbsp;</th>
									<td><input type="submit" class="submit" id="regist" value="同意以下协议并注册">
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验在线购物！ <a href="${pageContext.request.contextPath}/loginPage">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
